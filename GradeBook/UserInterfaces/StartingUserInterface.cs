...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            var name = parts[1];
            var weightedBool = bool.Parse(parts[3]);
            BaseGradeBook gradeBook;
            if (parts[2].Equals("standard"))
            {
                gradeBook = new StandardGradeBook(name, weightedBool);
            }
            else if (parts[2].Equals("ranked")){
                gradeBook = new RankedGradeBook(name, weightedBool);
            }
            else {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' is the name of the gradebook," +
                " 'Type' is what type of grading it should use, and 'Weighted' is whether or not grades should be weighted (true or false).");
            Console.WriteLine();
